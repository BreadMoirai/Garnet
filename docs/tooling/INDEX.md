...
- [Package Move Mechanics](package-move-mechanics.md) — Gotchas for moving files between packages across all six source sets without silently breaking discovery or content. Tags: gradle, kotlin, refactor, package-move, sed, verification.
