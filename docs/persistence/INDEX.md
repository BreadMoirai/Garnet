...
- [Spec on-disk format](spec-on-disk-format.md) — `.spec.kts` files, file naming, save dir, no-JSON-on-disk, and standalone `.nbt` structures placeable/creatable directly from the Explorer. Tags: storage, scripting
