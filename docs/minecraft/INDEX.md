...
- [Overriding Window framebuffer size on MC 26.2 (viewport-shrink lever)](window-framebuffer-override-26.md) — WindowMixin cancels six Window getters/setters to shrink the reported framebuffer size; corrects a WindowEventHandler.framebufferSizeChanged() assumption (real method is resizeGui()), and notes calculateScale/setGuiScale read shadowed fields directly. _Tags: mc-api, mixins, versions, quirks, render-state_
