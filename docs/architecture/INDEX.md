...
- [Module map](module-map.md) — Tour of the source tree (`core/spec/`, `core/async/`, `core/events/`, `editor/structure/`, `core/config/`, `dock/`, `playback/`, `testing/`, `editor/`), package responsibilities, dependency direction, and where to start reading for a given concern. Tags: modules, layout, dependencies, entry-points.
