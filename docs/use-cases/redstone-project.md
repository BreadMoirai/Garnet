...
| UC-MAN-04.d | Anchor block placed; `SpecBlockEntity.projectSourcePath` set and not persisted to NBT | `EditorDimSpec."load places cells in the managed dim and registers a session"` | **GAP-PARTIAL** |
