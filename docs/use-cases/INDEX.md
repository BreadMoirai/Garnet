...
- [Structure lifecycle](structure-lifecycle.md) — `.nbt` save/load on both paths, standalone-`.nbt` debounced auto-save with local history, and restoring a banked revision from the Local History panel (UC-MAN-10, UC-PER-06/07). Tags: structure, autosave, save, history.
