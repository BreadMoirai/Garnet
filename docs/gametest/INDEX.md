...
> Note: the suite-author guide `strict-contract-scenarios.md` was retired with the SpecMode removal — gametests are currently placeholder stubs pending re-authoring against the flat `SpecEntry` model.
