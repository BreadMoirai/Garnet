...
data class ProjectFolderTree(
    ...
    companion object {
        ...
        fun scan(root: ProjectRoot): ProjectFolderTree {
            if (!Files.isDirectory(root.path)) return ProjectFolderTree(emptyList(), emptySet())
            ...
            return ProjectFolderTree(leaves.sortedBy { it.subpath }, intermediates)
        }
    }
}
