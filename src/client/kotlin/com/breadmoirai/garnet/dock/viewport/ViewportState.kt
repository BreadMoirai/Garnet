 ...
 *
 * When [active], [WindowMixin][com.breadmoirai.garnet.mixin.client.WindowMixin] overrides
...
object ViewportState {
    ...
    /**
     * Real (un-overridden) framebuffer width, cached by [WindowMixin][com.breadmoirai.garnet.mixin.client.WindowMixin]
    ...
    /** Whether [WindowMixin][com.breadmoirai.garnet.mixin.client.WindowMixin] should apply its override. */
    ...
    fun contentRect(realW: Int, realH: Int): ContentRect {
        val insets = com.breadmoirai.garnet.dock.shell.DockState.insets()
