 ...
 * Rather than manage a raw GL texture that [com.breadmoirai.garnet.dock.viewport.BlitUvPipeline]
...
object ComposeSurface {
    ...
    private fun ensureHost(width: Int, height: Int): ComposeSceneHost {
        ...
        val h = ComposeSceneHost(width, height) {
            com.breadmoirai.garnet.dock.shell.GarnetDock(
                width,
                height,
                { com.breadmoirai.garnet.dock.viewport.commitDockVisibilityChange() },
            )
        }
        host = h
