...
private val keyToggleViewportShrink = KeyMappingHelper.registerKeyMapping(
    KeyMapping("key.garnet.viewport_shrink_toggle", GLFW_KEY_V, KeyMapping.Category.MISC)
)

private val keyToggleComposeOverlay = KeyMappingHelper.registerKeyMapping(
    KeyMapping("key.garnet.compose_overlay_toggle", GLFW_KEY_C, KeyMapping.Category.MISC)
)

/**
 * Registers the spike keybind that flips [ViewportState.active] and asks the [WindowMixin][
 * com.breadmoirai.garnet.mixin.client.WindowMixin] to recompute its framebuffer-size
