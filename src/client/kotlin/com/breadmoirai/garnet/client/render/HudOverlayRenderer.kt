...
private val keyCycleForward = KeyMappingHelper.registerKeyMapping(
    KeyMapping("key.garnet.cycle_forward", 93, KeyMapping.Category.MISC) // ] key
)
private val keyCycleBackward = KeyMappingHelper.registerKeyMapping(
    KeyMapping("key.garnet.cycle_backward", 91, KeyMapping.Category.MISC) // [ key
)
...
fun registerHudOverlay() {
    HudElementRegistry.addLast(
        Identifier.fromNamespaceAndPath("garnet", "spec_info"),
