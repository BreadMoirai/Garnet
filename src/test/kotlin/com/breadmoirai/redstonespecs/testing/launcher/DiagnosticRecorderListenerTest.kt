...
class DiagnosticRecorderListenerTest : FunSpec({
    ...
    // Coverage gap: the afterTest contract (write RecordingHolder → call afterTest → assert
    ...
    // runRedstoneSpec writes to RecordingHolder in the coroutine context, the listener's
    // afterTest reads it into byTestName, and the resulting snapshot feeds
    // LauncherResult.recordings.
    //
